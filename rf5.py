...
# print("\n test evaluation")
# print(f"best model: n_estimators={best_params['n_estimators']}, max_depth={best_params['max_depth']},  UA_train_avg={best_params['UA_train_avg']}, WA_train_avg={best_params['WA_train_avg']}, UA_val_avg={best_params['UA_val_avg']}, UA_test={best_params['UA_test']}, WA_test={best_params['WA_test']},")
...
# … everything up through saving and printing df_results …
...
# ——— ADD THIS BLOCK ———
# Plot train, validation and test weighted accuracy across experiments
plt.figure(figsize=(10, 6))

# x-axis: one point per experiment
